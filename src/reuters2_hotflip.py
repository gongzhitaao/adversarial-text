...
data = os.path.expanduser(
    '~/data/reuters/reuters2/reuters2-char-seqlen-{0}-wordlen-{1}.npz'
...
train(env, X_train, y_train, X_valid, y_valid, load=load, epochs=10,
      batch_size=cfg.batch_size, name='reuters2-char-sigm')
...
evaluate(env, X_adv[0], y_test, batch_size=cfg.batch_size)
np.save('out/reuters2_hotflip_beam-{}'.format(cfg.beam_width), X_adv)
