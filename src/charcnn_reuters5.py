...
env.y = tf.placeholder(tf.int32, [cfg.batch_size])
...
data = os.path.expanduser(
    '~/data/reuters/reuters5/reuters5-char-seqlen-{0}-wordlen-{1}.npz'
...
train(env, X_train, y_train, X_valid, y_valid, load=load, epochs=5,
      batch_size=cfg.batch_size, name='reuters5-char')
